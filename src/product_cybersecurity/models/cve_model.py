...
#   timestamp: 2025-05-11T18:35:17+00:00
...
class CveId(RootModel[constr(pattern=r'^CVE-[0-9]{4}-[0-9]{4,19}$')]):
    root: constr(pattern=r'^CVE-[0-9]{4}-[0-9]{4,19}$')
...
class Versions(BaseModel):
    ...
    versionType: Optional[constr(min_length=1, max_length=128)] = Field(
        None,
    ...
    lessThan: Optional[Version] = Field(
        None,
    ...
    lessThanOrEqual: Optional[Version] = Field(
        None,
...
class Product(BaseModel):
    vendor: Optional[constr(min_length=1, max_length=512)] = Field(
        None,
    ...
    product: Optional[constr(min_length=1, max_length=2048)] = Field(
        None, description='Name of the affected product.'
    )
    collectionURL: Optional[UriType] = Field(
        None,
    ...
    packageName: Optional[constr(min_length=1, max_length=2048)] = Field(
        None,
        description='Name or identifier of the affected software package as used in the package collection.',
    )
    cpes: Optional[List[Cpe22and23]] = Field(
        None,
    ...
    programFiles: Optional[List[ProgramFile]] = Field(
    ...
    defaultStatus: Optional[Status] = Field(
        None,
    ...
    versions: Optional[List[Union[Versions, Versions1, Versions2, Versions3]]] = Field(
        None,
...
class CveMetadataPublished(BaseModel):
    ...
    dateReserved: Optional[Timestamp] = Field(
        None,
    ...
    datePublished: Optional[Timestamp] = Field(
        None,
...
class CveMetadataRejected(BaseModel):
    ...
    dateRejected: Optional[Timestamp] = Field(
...
class ProviderMetadata(BaseModel):
    ...
    shortName: Optional[ShortName] = Field(
...
class CpeMatch(BaseModel):
    ...
    vulnerable: bool
    criteria: Cpe23
    matchCriteriaId: Optional[UuidType] = None
    versionStartExcluding: Optional[Version] = None
    versionStartIncluding: Optional[Version] = None
    versionEndExcluding: Optional[Version] = None
    versionEndIncluding: Optional[Version] = None
...
class Language(
    ...
    root: constr(
        pattern=r'^[A-Za-z]{2,4}([_-][A-Za-z]{4})?([_-]([A-Za-z]{2}|[0-9]{3}))?$'
    ) = Field(..., description='BCP 47 language code, language-region.')
...
class TaxonomyMapping(BaseModel):
    ...
    taxonomyVersion: Optional[constr(min_length=1, max_length=128)] = Field(
...
class CnaTags(RootModel[List[Union[TagExtension, CnaTags1]]]):
    root: List[Union[TagExtension, CnaTags1]] = Field(
        ...,
...
class AdpTags(RootModel[List[Union[TagExtension, AdpTags1]]]):
    root: List[Union[TagExtension, AdpTags1]] = Field(
        ...,
...
class Reference(BaseModel):
    ...
    name: Optional[constr(min_length=1, max_length=512)] = Field(
        None,
        description='User created name for the reference, often the title of the page.',
    )
    tags: Optional[List[Union[TagExtension, Tags]]] = Field(
        None,
...
class Description(BaseModel):
    ...
    supportingMedia: Optional[List[SupportingMediaItem]] = Field(
        None,
...
class Impact(BaseModel):
    ...
    capecId: Optional[
        constr(pattern=r'^CAPEC-[1-9][0-9]{0,4}$', min_length=7, max_length=11)
...
class CvssV406(BaseModel):
    ...
    modifiedAttackVector: Optional[ModifiedAttackVectorTypeModel] = 'NOT_DEFINED'
    ...
    modifiedUserInteraction: Optional[ModifiedUserInteractionTypeModel] = 'NOT_DEFINED'
...
class Metrics1(BaseModel):
    ...
    format: Optional[constr(min_length=1, max_length=64)] = Field(
        None,
    ...
    cvssV3_1: Optional[Union[CvssV31, CvssV311, CvssV312, CvssV313, CvssV314]] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 3.1'
    )
    cvssV3_0: Optional[Union[CvssV30, CvssV301, CvssV302, CvssV303, CvssV304]] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 3.0'
    )
    cvssV2_0: Optional[CvssV20] = Field(
...
class Metrics2(BaseModel):
    ...
    cvssV4_0: Optional[CvssV4022] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 4.0'
    )
    cvssV3_1: Union[CvssV315, CvssV316, CvssV317, CvssV318, CvssV319] = Field(
        ..., title='JSON Schema for Common Vulnerability Scoring System version 3.1'
    )
    cvssV3_0: Optional[Union[CvssV305, CvssV306, CvssV307, CvssV308, CvssV309]] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 3.0'
    )
    cvssV2_0: Optional[CvssV201] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 2.0'
    )
    other: Optional[Other] = Field(
        None,
...
class Metrics3(BaseModel):
    ...
    cvssV4_0: Optional[CvssV4023] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 4.0'
    )
    cvssV3_1: Optional[Union[CvssV3110, CvssV3111, CvssV3112, CvssV3113, CvssV3114]] = (
        Field(
            None,
            title='JSON Schema for Common Vulnerability Scoring System version 3.1',
        )
    )
    cvssV3_0: Union[CvssV3010, CvssV3011, CvssV3012, CvssV3013, CvssV3014] = Field(
        ..., title='JSON Schema for Common Vulnerability Scoring System version 3.0'
    )
    cvssV2_0: Optional[CvssV202] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 2.0'
    )
    other: Optional[Other] = Field(
        None,
...
class Metrics4(BaseModel):
    ...
    cvssV4_0: Optional[CvssV4024] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 4.0'
    )
    cvssV3_1: Optional[Union[CvssV3115, CvssV3116, CvssV3117, CvssV3118, CvssV3119]] = (
        Field(
            None,
            title='JSON Schema for Common Vulnerability Scoring System version 3.1',
        )
    )
    cvssV3_0: Optional[Union[CvssV3015, CvssV3016, CvssV3017, CvssV3018, CvssV3019]] = (
        Field(
            None,
            title='JSON Schema for Common Vulnerability Scoring System version 3.0',
        )
...
class Metrics5(BaseModel):
    ...
    cvssV4_0: Optional[CvssV4025] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 4.0'
    )
    cvssV3_1: Optional[Union[CvssV3120, CvssV3121, CvssV3122, CvssV3123, CvssV3124]] = (
        Field(
            None,
            title='JSON Schema for Common Vulnerability Scoring System version 3.1',
        )
    )
    cvssV3_0: Optional[Union[CvssV3020, CvssV3021, CvssV3022, CvssV3023, CvssV3024]] = (
        Field(
            None,
            title='JSON Schema for Common Vulnerability Scoring System version 3.0',
        )
    )
    cvssV2_0: Optional[CvssV204] = Field(
        None, title='JSON Schema for Common Vulnerability Scoring System version 2.0'
    )
    other: Other = Field(
        ...,
...
class Metrics(RootModel[List[Union[Metrics1, Metrics2, Metrics3, Metrics4, Metrics5]]]):
    root: List[Union[Metrics1, Metrics2, Metrics3, Metrics4, Metrics5]] = Field(
...
class CnaRejectedContainer(BaseModel):
    # RRIV
    # Same fix as CnaPublishedContainer
    ...
    replacedBy: Optional[List[CveId]] = Field(
        None,
...
class Description1(BaseModel):
    ...
    cweId: Optional[
        constr(pattern=r'^CWE-[1-9][0-9]*$', min_length=5, max_length=9)
    ] = Field(
        None,
        description='CWE ID of the CWE that best describes this problemType entry.',
    )
    type: Optional[constr(min_length=1, max_length=128)] = Field(
...
class CnaPublishedContainer(BaseModel):
    # HOTFIX RRIV: 
    # we allow additional fields because we have no way of handling Pattern Property right now
    # meaning that any field with this pattern "^x_[^.]*$" (such as x_engine) would cause the parsing to fail
    # This should be fine
    ...
    affected: Affected
    cpeApplicability: Optional[List[CpeApplicabilityElement]] = None
...
class Containers(BaseModel):
    ...
    adp: Optional[List[AdpContainer]] = Field(None, min_length=1)
...
class CveJsonRecordFormat(RootModel[Union[CveJsonRecordFormat1, CveJsonRecordFormat2]]):
    root: Union[CveJsonRecordFormat1, CveJsonRecordFormat2] = Field(
        ...,
